...
/**
* Date tasks
* @author Neullo <neullo@sheng.co.ke>
* @copyright 2013 Go Sheng Services
*/
class Mdate extends DateTime 
{
	 ...
	 *
	 * @param Mdate $startDate Starting date.
	 * @param Mdate $endDate Finishing date.
	 * @return int Number of days between start and end dates.
	 */
	static public function dateDiff(Mdate $startDate, Mdate $endDate) {
	 ...
	 *
	 * @param Mdate $endDate Date that is to be compared with object.
	 * @return int Number of days between both dates.
	 */
	public function dateDiff2(Mdate $endDate) {
